from libraries.functions_algo import initialisation, first_proposition, gain_quota
...
list_persons, nb_persons, list_papers, objectif = initialisation(ConfigsFile, AffFile, ProdFile)
...
list_persons, list_papers, nb_proposed_papers = gain_quota(list_persons, list_papers, objectif, nb_proposed_papers)
